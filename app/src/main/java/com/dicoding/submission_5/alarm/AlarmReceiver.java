package com.dicoding.submission_5.alarm;
...
import com.dicoding.submission_5.MainActivity;
                ...
                public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                    ...
                    try {
                        ...
                        for (Movie iMovie: movie){
                            if(iMovie.getMv_name() == movie.get(movie.size() - 1).getMv_name()){
                                notif = notif + iMovie.getMv_name();
                            }else{
                                notif = notif + iMovie.getMv_name() + ", ";
                            }
