...
public class FavMovieWidget extends AppWidgetProvider {
    private static final String TOAST_ACTION = "com.dicoding.submission_5.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.dicoding.submission_5.EXTRA_ITEM";
